...
import 'package:jhipsterFlutterSampleApp/keys.dart';
...
class LoginScreen extends StatelessWidget {
  LoginScreen({Key key}) : super(key: JhipsterFlutterSampleAppKeys.mainScreen);
    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if(state.status.isSubmissionSuccess){
          Navigator.pushNamed(context, JhipsterFlutterSampleAppRoutes.main);
        }
      },
      child: Scaffold(
          appBar: AppBar(
  ...
  Widget register(BuildContext context) {
    return RaisedButton(
      ...
      onPressed: () => Navigator.pushNamed(context, JhipsterFlutterSampleAppRoutes.register),
    );
  }
